...
// item缓存
var (
	// IndexedItem的内存缓存, key: cmodel.GraphItem.Checksum() / value: cmodel.GraphItem.UUID()-dstype-step(string)
	IndexedItemCache   = NewIndexCacheBase()
	// unIndexedItem的内存缓存, key: cmodel.GraphItem.Checksum() / value: cmodel.GraphItem
